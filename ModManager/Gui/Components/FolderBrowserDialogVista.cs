...
namespace ModManager.Gui.Components
{
    ...
    public class FolderBrowserDialogVista : CommonDialog
    {
        ...
        /// <summary>
        /// Creates a new instance of the <see cref="FolderBrowserDialogVista" /> class.
        /// </summary>
        public FolderBrowserDialogVista()
            : this(false)
        {
        }
        ...
        public FolderBrowserDialogVista(bool forceDownlevel)
        {
